  ...
  async function handleSubmit(event) {
    ...
    try {
      await partnerApi.decideSmartPlannerBooking(detailState.booking.bookingId, {
        ...
        discountPercentage: canCreateWeddChance ? Number(form.discountPercentage) : null,
        specialPricePerGuest: canCreateWeddChance ? Number(form.specialPricePerGuest) : null,
        allowGuestCountAdjustment: canCreateWeddChance ? form.allowGuestCountAdjustment === 'true' : null,
        minGuestCount: canCreateWeddChance && form.allowGuestCountAdjustment === 'true' ? Number(form.minGuestCount) : null,
        maxGuestCount: canCreateWeddChance && form.allowGuestCountAdjustment === 'true' ? Number(form.maxGuestCount) : null,
          ...
          {detailState.status === 'ready' && detailState.booking ? (
            <>
              <article className="partner-dashboard__smartplanner-card">
                <div className="partner-dashboard__workspace-header">
                  <div>
                    <span className="partner-dashboard__workspace-eyebrow">Prosba o anulacje</span>
                ...
                <form className="partner-dashboard__form" onSubmit={(event) => void handleSubmit(event)}>
                  ...
                  <label className="partner-dashboard__field">
                    ...
                    <input
                      ...
                      disabled={!canCreateWeddChance}
                      onChange={(event) => setForm((current) => ({ ...current, specialPricePerGuest: event.target.value }))}
                    />
                  </label>
